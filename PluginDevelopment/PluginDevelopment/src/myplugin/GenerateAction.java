...
class GenerateAction extends MDAction{
	...
	public void actionPerformed(ActionEvent evt) {
		...
		try {
			...
			for(FMMicroservice micro:FMModel.getInstance().getMicroservices()) {
				JOptionPane.showMessageDialog(null, micro.getName());
			}
			
			JOptionPane.showMessageDialog(null, "Micronaut Generate pokrenuto.");
			exportToXml();
